...
//ROOM
#define ROOM                                       "room1"                                //Thay tên phòng cho đúng
...
#define MQTT_CLIENT_ID                             "stm32f1-w5500-room1"                  //Thay ID
#define MQTT_KEEPALIVE                             60

// Net static (W5500)
#define NET_MAC                                    {0x00, 0x08, 0xDC, 0x11, 0x22, 0x33}   //Thay MAC chỗ này để ko trùng với bo khác
#define NET_IP                                     {192, 168,  10, 3}                     //Thay IP chỗ này để ko trùng với bo khác
